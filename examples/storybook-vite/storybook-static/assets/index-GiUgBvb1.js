...
var j = {
	...
	C = {};
function p(e, t, n) {
	((this.props = e), (this.context = t), (this.refs = C), (this.updater = n || j));
}
	...
	if (s)
		return (
			...
			E(o)
				...
				: o != null &&
					(w(o) && (o = J(o, n + (!o.key || (s && s.key === o.key) ? "" : ("" + o.key).replace(k, "$&/") + "/") + e)), t.push(o)),
			1
		);
	if (((s = 0), (u = u === "" ? "." : u + ":"), E(e)))
...
var A = R.exports;
const Y = V(A),
	ee = D({ __proto__: null, default: Y }, [A]);
export { Y as R, ee as a, Z as c, V as g, A as r };
