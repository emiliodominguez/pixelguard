...
var w = "storybook/actions",
	...
	C = (e) => !!(typeof e == "object" && e && E(e, (t) => /^Synthetic(?:Base)?Event$/.test(t.constructor.name)) && typeof e.persist == "function"),
	K = (e) => {
		if (C(e)) {
...
var T = (e, t) => typeof t[e] > "u" && !(e in t),
	...
	P = (e) => {
		...
		if (!(t != null && t.disable) && !m && "__STORYBOOK_TEST_ON_MOCK_CALL__" in d && typeof d.__STORYBOOK_TEST_ON_MOCK_CALL__ == "function") {
