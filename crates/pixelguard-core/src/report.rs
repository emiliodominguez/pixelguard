...
<body>
    <div class="container">
        <header class="header">
            <a href="https://github.com/pixelguard/pixelguard" class="logo" target="_blank">
        ...
        <footer class="footer">
            ...
            <a href="https://github.com/pixelguard/pixelguard" target="_blank">View on GitHub {external_link}</a>
        </footer>
    </div>
